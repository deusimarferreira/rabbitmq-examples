...
import co.villalabs.rabbitmq.RabbitmqApplication;
import co.villalabs.rabbitmq.application.ProductService;
...
import co.villalabs.rabbitmq.infrastructure.form.ProductFormToProduct;
...
public class ProductServiceImpl implements ProductService {
    ...
    public void sendProductMessage(String id) {
        ...
        rabbitTemplate.convertAndSend(RabbitmqApplication.SFG_MESSAGE_QUEUE, actionmap);
    }
}